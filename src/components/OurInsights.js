...
export default function OurInsights() {
  ...
  return (
    <section className={`w-full py-1 md:py-20 md:pl-16 flex flex-col items-center justify-center gap-3 md:gap-10 ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-black'}`}>
